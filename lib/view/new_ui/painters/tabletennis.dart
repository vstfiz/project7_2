...
class TableTennisPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(size.width*0.1041162,size.height*0.007215007),Offset(size.width*0.1041162,size.height*0.9062049),paint_8_stroke);
    ...
    canvas.drawLine(Offset(size.width*0.1016949,size.height*0.007215007),Offset(size.width*0.1016949,size.height*0.9062049),paint_9_stroke);

    Path path_10 = Path();
    path_10.moveTo(size.width*0.9055690,size.height*0.008658009);
    path_10.lineTo(size.width*0.9055690,size.height*0.9076479);
    ...
    Path path_11 = Path();
    path_11.moveTo(size.width*0.5036320,size.height*0.04906205);
    path_11.lineTo(size.width*0.5036320,size.height*0.9062049);
