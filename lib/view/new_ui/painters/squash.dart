...
class SquashPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(size.width*0.01452785,size.height*0.4862915),Offset(size.width*0.9878935,size.height*0.4862915),paint_7_stroke);

    Path path_8 = Path();
    path_8.moveTo(size.width*0.5036320,size.height*0.4877345);
    path_8.lineTo(size.width*0.5036320,size.height*0.9076479);
    ...
    canvas.drawRect(Rect.fromLTWH(size.width*0.01452785,size.height*0.4862915,size.width*0.3268765,size.height*0.1948052),paint_9_stroke);

    Paint paint_9_fill = Paint()..style=PaintingStyle.fill;
    paint_9_fill.color = Color(0xff000000).withOpacity(1.0);
    canvas.drawRect(Rect.fromLTWH(size.width*0.01452785,size.height*0.4862915,size.width*0.3268765,size.height*0.1948052),paint_9_fill);
    ...
    canvas.drawRect(Rect.fromLTWH(size.width*0.6634383,size.height*0.4862915,size.width*0.3268765,size.height*0.1948052),paint_10_stroke);

    Paint paint_10_fill = Paint()..style=PaintingStyle.fill;
    paint_10_fill.color = Color(0xff000000).withOpacity(1.0);
    canvas.drawRect(Rect.fromLTWH(size.width*0.6634383,size.height*0.4862915,size.width*0.3268765,size.height*0.1948052),paint_10_fill);
