...
class TennisPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(size.width*0.09927361,size.height*0.5194805),Offset(size.width*0.9055690,size.height*0.5194805),paint_8_stroke);
    ...
    canvas.drawLine(Offset(size.width*0.1041162,size.height*0.007215007),Offset(size.width*0.1041162,size.height*0.9062049),paint_9_stroke);
    ...
    canvas.drawLine(Offset(size.width*0.1016949,size.height*0.007215007),Offset(size.width*0.1016949,size.height*0.9062049),paint_10_stroke);

    Path path_11 = Path();
    path_11.moveTo(size.width*0.9055690,size.height*0.008658009);
    path_11.lineTo(size.width*0.9055690,size.height*0.9076479);
    ...
    Path path_12 = Path();
    path_12.moveTo(size.width*0.5036320,size.height*0.04906205);
    path_12.lineTo(size.width*0.5036320,size.height*0.5209235);
