...
class VenueBookings extends StatefulWidget{
  _VenueBookingsState createState()=> _VenueBookingsState();
}

class _VenueBookingsState extends State<VenueBookings>{
  TextEditingController _searchController = new TextEditingController();
  bool isAllSelected = true;
  bool isUpcomingSelected = false;
  bool isFinishedSelected = false;

  var all = ['upcoming','finished', 'upcoming','finished'];
  var upcoming = [];
  var finished = [];
      ...
      body: Container(
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              child: Container(
                height: Globals.getHeightLeftPanel(45),
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      height: Globals.getHeightLeftPanel(38),
                      ...
                      child: TextButton(
                        ...
                        child: AutoSizeText('All',style: GoogleFonts.montserrat(
                            fontSize: 16,
                            fontWeight: FontWeight.w400,
                            color: Colors.white
                        ),),
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        child: AutoSizeText('Upcoming',style: GoogleFonts.montserrat(
                            fontSize: 16,
                            fontWeight: FontWeight.w400,
                            color: Colors.white
                        ),),
                      ...
                      decoration: BoxDecoration(
                          color: isUpcomingSelected?Color(0xFF7585FF):Colors.black,
                          borderRadius: BorderRadius.circular(Globals.getWidth(9))
                      ),
                    ),
                    SizedBox(
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        child: AutoSizeText('Finished',style: GoogleFonts.montserrat(
                            fontSize: 16,
                            fontWeight: FontWeight.w400,
                            color: Colors.white
                        ),),
                      ...
                      decoration: BoxDecoration(
                          color: isFinishedSelected?Color(0xFF7585FF):Colors.black,
                          borderRadius: BorderRadius.circular(Globals.getWidth(9))
                      ),
                    ),
                  ],
              ...
              Container(
                ...
                child: ListView(
                  children: List.generate(all.length, (index) {
                    return all[index]=='upcoming'?Container(
