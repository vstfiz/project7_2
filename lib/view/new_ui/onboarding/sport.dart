      ...
      body: Container(
        ...
        child: Stack(
          ...
          children: [
                      ...
                      return Container(
                        ...
                        child: TextButton(
                          onPressed: (){
                            setState(() {
                              selIndex = index;
                              Globals.selectedSport = sports[index];
                            });
            ...
            Positioned(
                top: Globals.getHeight(85),
                left: Globals.getWidth(20),
                child: Container(
                  width: Globals.getWidth(280),
                  height: Globals.getHeight(280),
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/images/onboarding/cricket.png'),fit: BoxFit.contain
                      )
                  ),
                )),
            Positioned(
                top: Globals.getHeight(55),
                right: Globals.getWidth(1),
                child: Container(
                  width: Globals.getWidth(400),
                  height: Globals.getHeight(400),
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/images/onboarding/football1.png'),fit: BoxFit.contain
                      )
                  ),
                )),
          ],
