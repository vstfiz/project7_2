...
class _DataState extends State<Data> {
  ...
  String imageName;
  var uuid = Uuid();
  RegExp _dobRegex = new RegExp(
      r'^(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[13-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)0?2\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})$');
  String _defaultAddress =
      'https://raw.githubusercontent.com/vstfiz/vstfiz.github.io/master/images/';
  bool isSpinnerOpen = false;

  Future<String> _uploadImage(File file) async {
    print("image upload running");
    final Reference ref =
        FirebaseStorage.instance.ref().child('users/${uuid.v4()}.jpg');
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                  ...
                  left: isSpinnerOpen?Globals.getWidth(157):Globals.width * 0.22,
                          ...
                          if (EmailValidator.validate(
                            ...
                            if (_firstNameController.text != '') {
                              if (_lastNameController.text != '') {
                                if (_dobRegex.hasMatch(_dobController.text)) {
                                  ...
                                  AchievementView(context,
                                      title: "Invalid Date",
                                      subTitle: "Enter in DD/MM/YYYY format",
                                ...
                                AchievementView(context,
                                    ...
                                    subTitle: "Enter value in Last Name Field",
                                    //onTab: _onTabAchievement,
                                    icon: Icon(
                                      Icons.clear,
                                      color: Colors.red,
                              ...
                              AchievementView(context,
                                  ...
                                  subTitle: "Enter value in First Name Field",
                                  //onTab: _onTabAchievement,
                                  icon: Icon(
                                    Icons.clear,
                                    color: Colors.red,
                            ...
                            if (_firstNameController.text != '') {
                              if (_lastNameController.text != '') {
                                if (_dobRegex.hasMatch(_dobController.text)) {
                                  setState(() {
                                    isSpinnerOpen = true;
                                    Globals.creationDp = _defaultAddress +
