...
class _PickYourPositionsState extends State<PickYourPositions> {
  ...
  initState(){
    ...
    selected = List.filled(positions.length, false,growable: false);
    super.initState();
  }
  int selIndex;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        height: Globals.height + Globals.getHeight(110) * (positions.length - 3),
        width: Globals.width,
        child: SingleChildScrollView(
          ...
          width: Globals.width,),
              ...
              Positioned(
                  ...
                  child: Container(
                    width: Globals.width,
                    height: Globals.getHeight(110) * positions.length,
                    child: Column(
                      children: List.generate(positions.length, (index) {
                        return Container(
                          ...
                          child: TextButton(
                            ...
                            child: Text(positions[index].toUpperCase(),textAlign:TextAlign.center,style: GoogleFonts.montserrat(fontSize: Globals.getFontSize(17),fontWeight: FontWeight.w400, letterSpacing: 2.89, color: Colors.white),),
                          ),
                          decoration: BoxDecoration(
                              color: selected[index]?Color(0xFF7585FF):Colors.black,
