...
import '../create_game/create_game_event.dart';
import '../left_side_navigation/left_panel.dart';
import '../profile/chat_screen_single.dart';
          ...
          return ClipRect(
            child: BackdropFilter(
              ...
              child: AlertDialog(
                ...
                content: Container(
                  height: Globals.getHeight(60) * Globals.myTeams.length,
                  width: Globals.width * 0.8,
                  child: ListView(
                    children: List.generate(Globals.myTeams.length, (index) {
                      return (Globals.myTeams.length - 1 == index)
                          ? Container(
                              width: Globals.width * 0.8,
            ...
            child: Stack(
              ...
              children: [
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(this.widget.searchResult['dp']),
                            fit: BoxFit.cover)),
                  ),
                ),
                Positioned(
                ...
                Positioned(
                    ...
                    child: Text(
                      this.widget.searchResult['status'],
                      style: GoogleFonts.montserrat(
                        ...
                        Column(
                          children: [
                            ...
                            Column(
                              children: [
                                Text(
                                  this.widget.searchResult['friends_count'],
                                  style: GoogleFonts.montserrat(
                                      color: Colors.white,
                                      fontSize: Globals.getFontSize(22),
                                      fontWeight: FontWeight.w600),
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    this.widget.searchResult['position'],
                                    style: GoogleFonts.montserrat(
                                        color: Colors.white,
                                        fontSize: Globals.getFontSize(14),
                                        fontWeight: FontWeight.w500),
                            ...
                            Column(
                              children: [
                                Text(
                                  this.widget.searchResult['experience'],
                                  style: GoogleFonts.montserrat(
                                      color: Colors.white,
                                      fontSize: Globals.getFontSize(22),
                                      fontWeight: FontWeight.w600),
                        ...
                        Column(
                          children: [
                            ...
                            Column(
                              children: [
                                Text(
                                  this.widget.searchResult['games_count'],
                                  style: GoogleFonts.montserrat(
                                      color: Colors.white,
                                      fontSize: Globals.getFontSize(22),
                                      fontWeight: FontWeight.w600),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context)
                              ...
                              return ChatScreenSingle(
                                userName: this.widget.searchResult['name'],
                              );
                            }));
                          },
                          child: Container(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: List.generate(
                                  int.parse(
                                      this.widget.searchResult['teams_count']),
                                  (index) {
                        ...
                        Column(
                          children: [
                            ...
                            Text(
                              this.widget.searchResult['no_shows'],
                              style: GoogleFonts.montserrat(
                                  color: Colors.white,
                                  fontSize: Globals.getFontSize(20),
                                  fontWeight: FontWeight.w500),
    ...
    return Stack(
      children: [
                    ...
                    children: [
                      ...
                      Container(
                        height: Globals.getHeight(
                            (matches.values.toList().elementAt(index) * 18)
                                .toDouble()),
        ...
        Positioned(
          ...
          top: Globals.getHeight(115),
          right: Globals.getWidth(25),
        )
      ],
    );
  }
    ...
    return Column(
      ...
      children: List.generate(4, (index) {
        return Container(
          decoration: BoxDecoration(
              border: Border(
                  bottom: BorderSide(color: Colors.white54.withOpacity(0.3)))),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    image: DecorationImage(
                        image: AssetImage(matchData[index].imagePath),
                        fit: BoxFit.cover)),
              ),
              SizedBox(
